...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((WordViewHolder) viewHolder).layout;
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        listener.onRemoved(((WordViewHolder) viewHolder).textViewWord.getText().toString());
    }
    ...
    public interface SwipeToDeleteCallbackListener {
        void onRemoved(String wordString);
    }
}
